...
```
php composer.phar require wodrow/yii2-scheduling "dev-master"
```

or add

```json
"wodrow/yii2-scheduling": "dev-master"
```
...
First of all, you should include dependency to the `wodrow\yii2-scheduling` into your composer.json:

```
...
'require': {
    "wodrow/yii2-schedule": "*"
}
...
```
...
```php
'schedule' => 'wodrow\scheduling\Schedule',
```
